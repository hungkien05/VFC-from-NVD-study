...
Replication package of the paper "Mapping NVD Records to Their VFCs: How Hard is it?", accepted to ACM Transactions on Software Engineering and Methodology (TOSEM)
